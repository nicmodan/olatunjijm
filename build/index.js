      ...
      getAllEqupmentDisplay += `
        ...
        >
          <div class="section-equipment-img">
            <img src="${equpmentObjList[val]["equipment_ulr"]}" alt="${equpmentObjList[val]["equpment"]} image" />
            <div
...
const displayConcreate = () =>{
  ...
  getObjectKeys.map((val, idx) =>{
    getAllEqupmentDisplay += `
      ...
      >
        <div class="section-equipment-img">
          <img src="${concreateImages[val]["concreate_url"]}" alt="${concreateImages[val]["concreatName"]} image" />
          <div
              class="section-equipment-img-hover"
              onmousemove="handelMouseMoveDisplayText('section-equipment-img-hover-text-${idx}', 'equpment', ${idx})"
              onmouseout="handelMouseMovehiddeText('section-equipment-img-hover-text-${idx}', 'equpment', ${idx})"
        ...
        <div class="section-equipment-info">
          <h1>
            ${concreateImages[val]["concreatName"]}
          </h1>
        </div>
      </div>
    `
...
const displaySalessupply = () =>{
  ...
  getObjectKeys.map((val, idx) =>{
    getAllEqupmentDisplay += `
      ...
      >
        <div class="section-equipment-img">
          <img src="${sallersSupplyImg[val]["sallersSuppl_url"]}" alt="${sallersSupplyImg[val]["sallersSupplyName"]} image" />
          <div
              class="section-equipment-img-hover"
              onmousemove="handelMouseMoveDisplayText('section-equipment-img-hover-text-${idx}', 'equpment', ${idx})"
              onmouseout="handelMouseMovehiddeText('section-equipment-img-hover-text-${idx}', 'equpment', ${idx})"
        ...
        <div class="section-equipment-info">
          <h1>
            ${sallersSupplyImg[val]["sallersSupplyName"]}
          </h1>
        </div>
      </div>
    `
...
const displayGallary = (numbers, type)=>{
  ...
  if (type === "home") {
    ...
    getObjectKeys.map((val, idx) =>{
      ...
      >
        <img src=${gallaryImage[val]['eventName_url']} alt="${gallaryImage[val]['eventName']} image" />
        <div
